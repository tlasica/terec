def sample_build_info() -> dict:
    return {'_class': 'org.jenkinsci.plugins.workflow.job.WorkflowRun',
            'actions': [{'_class': 'hudson.model.CauseAction',
                        ...
                        {'_class': 'hudson.plugins.git.util.BuildData',
                         'buildsByBranchName': {'origin/cassandra-3.11': {'_class': 'hudson.plugins.git.util.Build',
                                                                          'buildNumber': 501,
                                                                          'buildResult': None,
                                                                          'marked': {
                                                                          ...
                                                                          'revision': {
                                                                              ...
                                                                              'branch': [{
                                                                                             'SHA1': '6212b0aaa524b004c4a2477b4e5383b08ebc354b',
                                                                                             'name': 'origin/cassandra-3.11'}]}}},
                         'lastBuiltRevision': {'SHA1': '6212b0aaa524b004c4a2477b4e5383b08ebc354b',
                                               'branch': [{'SHA1': '6212b0aaa524b004c4a2477b4e5383b08ebc354b',
                                                           'name': 'origin/cassandra-3.11'}]},
            ...
            'changeSets': [],
            'culprits': [{'absoluteUrl': 'https://ci-cassandra.apache.org/user/brandonwilliams',
