...
def test_get_failed_tests_for_suite_runs(cassandra_model, public_project):
    # given some runs
    suite, suite_runs, test_runs = generate_suite_with_test_runs(
        public_project.org, public_project.name
    )
...
def test_load_test_case_runs_without_config(cassandra_model, public_project):
    # given some runs
    branch = "main"
    suite, suite_runs, test_runs = generate_suite_with_test_runs(
        public_project.org, public_project.name, branch
    )
...
def test_load_test_case_runs_with_config(cassandra_model, public_project):
    # given some runs
    branch = "main"
    suite, suite_runs, test_runs = generate_suite_with_test_runs(
        public_project.org, public_project.name, branch
...
def test_load_test_case_runs_with_result(cassandra_model, public_project):
    # given some runs
    branch = "main"
    suite, suite_runs, test_runs = generate_suite_with_test_runs(
        public_project.org, public_project.name, branch
