...
def history(suite: str, branch: str, org: str = None, project: str = None):
    ...
    table = Table(show_header=True, header_style="bold magenta", title=title, title_justify="left", caption=caption, caption_justify="left")
...
@builds_app.command()
def histogram(suite: str, branch: str, field: str = None, org: str = None, project: str = None):
    """
...
@builds_app.command()
def bar(suite: str, branch: str, field: str = None, org: str = None, project: str = None):
    """
